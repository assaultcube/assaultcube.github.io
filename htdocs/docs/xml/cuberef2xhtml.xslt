          ...
          <div class="docsmain">
            ...
            <ul>
              <li>
                ...
                <br />Example: <span class="code">alias thegrass "is greener"</span>
              </li>
              <li>
                Use <span class="code">;</span> to sequence multiple commands into one.
                <br />Example: <span class="code">alias thegrass "is greener"; alias thesky "is blue"</span>
              </li>
              <li>
                Use <span class="code">$</span> to capture the value of a variable/alias/backeted-string as an argument for a command.
                <br />Example: <span class="code">echo "The grass" $thegrass</span>
                <br />Example: <span class="code">echo "Your FOV is" $fov</span>
              </li>
              <li>
                ...
                <br />Example: <span class="code">if thegrass $arg1 [ echo "This grass is too green" ]</span>
              </li>
              <li>
                ...
                <br />Example: <span class="code">alias thegrass [ alias thegrass2 [ alias thegrass3 "is greener" ] ]</span>
                <br />Example: <span class="code">alias thegrass [ if (= $arg1 "is greener") [ echo "is too green" ] ]</span>
              </li>
            </ul>
            <p>
